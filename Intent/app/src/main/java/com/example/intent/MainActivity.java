    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn1:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Farrel Ahmad Yudithia");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NIM, "21120119130067");
